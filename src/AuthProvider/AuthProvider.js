...
import { createUserWithEmailAndPassword, getAuth, GoogleAuthProvider, onAuthStateChanged, signInWithEmailAndPassword, signInWithPopup, signOut, updateProfile, updatePassword, sendPasswordResetEmail, FacebookAuthProvider } from "firebase/auth"
...
const AuthProvider = ({ children }) => {
    ...
    const FacebookSignIn = ()=> {
      setLoader(true)
      return signInWithPopup(auth,facebookProbider).then((result) => {

...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://final-project-server-assignmen.vercel.app/products/${params.company}`
          ),
      },
      {
        path: '/blogs',
      ...
      },
      {
        ...
        loader: () =>
          fetch('https://final-project-server-assignmen.vercel.app/hand'),
      },
      {
        path: '/hand/:id',
        ...
        loader: ({ params }) =>
          fetch(
            `https://final-project-server-assignmen.vercel.app/hand/${params.id}`
          ),
      },
    ],
  },

...
const Login = () => {
  const { loginUsers, googleLogIn, FacebookSignIn } = useContext(AuthContext);
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    <div className=" grid justify-center items-center bg-black text-white font-bold mx-2">
      <form onSubmit={handleSubmit(hadleLogingSubmit)}>
        ...
        <div className="text-center">
          <div
            className="text-center my-4 tooltip tooltip-primary tooltip-top"
            data-tip="Login Now"
          >
      ...
      <div
        className="text-center btn text-red-500 text-xl pt-2 my-2 tooltip tooltip-primary tooltip-top"
        data-tip="Forgate Password"
      >
      ...
      <div className="mb-7">
        <p>
          Are You New User ?{' '}
          <Link
            className="text-teal-400 tooltip tooltip-primary tooltip-top hover:text-black hover:bg-white"
            to="/register"

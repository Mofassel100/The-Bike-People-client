...
const Footer = () => {
    return (
        <div>
 <footer className="footer text-white p-10 bg-slate-500 text-base-content">
        <div>
          <span className="footer-title">Services</span> 
          <a className="link link-hover">Zero Bikes</a> 
          <a className="link link-hover">Aprilia Bikes</a> 
          <a className="link link-hover">TVS Bikes</a> 
          <a className="link link-hover">Advertisement</a>
        </div> 
        <div>
          <span className="footer-title">Old Bikes Page Sales</span> 
      ...
      <footer className="footer px-10 py-4 border-t  text-white p-10 bg-slate-500 text-base-content border-base-300">
        <div className="items-center grid-flow-col">
          ...
          <p>Old Bikes Ltd. <br/>Providing reliable tech since 2022</p>
        </div> 

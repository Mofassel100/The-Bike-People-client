        ...
        <form onSubmit={handleSubmit(addProductSubmit)}>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2'>
                <div>
                    ...
                    <select className='px-5 py-3 text-white bg-black border-white' {...register("size")}>
                        <option selected className='p-3 ' value="S">S</option>
                        <option className='p-3' value="M">M</option>
                        <option className='p-3' value="L">L</option>
                        <option className='p-3' value="XL">XL</option>
                        <option className='p-3' value="XXL">XXL</option>
                    </select>
                </div>
                <div className="form-control w-full max-w-xs">
                    ...
                    <input type="text" className="input text-black font-bold input-bordered w-full max-w-xs" {...register("names", { required: "Name in required" })} placeholder="Enter Your name" />
                </div>
                <div className="form-control w-full max-w-xs">
                    <label className="label">
                    ...
                    } readOnly className="input input-bordered w-full max-w-xs text-black font-bold" />
                </div>
                <div className="form-control w-full max-w-xs">
                    <label className="label">
                    ...
                    <input type="email" defaultValue={user?.email} readOnly className="input input-bordered text-black font-bold w-full max-w-xs" {...register("eamil", { required: "Name in required" })} placeholder="Enter Your Email" />
                </div>
                <div required className="form-control w-full max-w-xs">
                    ...
                    <input type="file" className="input input-bordered w-full text-black font-bold max-w-xs " {...register("photoURL")} placeholder="Enter Your photo URL" />
                </div>
                <div className="form-control w-full max-w-xs">
                    <label className="label">
                        <span className="">Orginal Price</span>
                    </label>
                    <input type="number" className="input input-bordered w-full max-w-xs text-black font-bold" {...register("Orprice", { required: "Email Address in required" })} placeholder="Enter Your Email" />
                    <br />
                </div>
                {/* <div className="form-control w-full max-w-xs">
                    <label className="label">
                ...
                <div className="form-control w-full max-w-xs">
                    ...
                    <input type="number" className="input input-bordered w-full max-w-xs text-black font-bold" {...register("phone", {
                ...
                <div className=''>
                    ...
                    <select required className='px-5 py-3 text-white bg-black border-white' {...register("commetsType")}>
                ...
                <div className='my-3'>
                    <p>Location :</p>
                    <select required className='px-5 py-3 text-white bg-black border-white' {...register("location")}>
                ...
                <div className='my-3'>
                    <p>Product Color</p>
                    <select required className='px-5 py-3 text-white bg-black border-white' {...register("useTime")}>
                        <option className='p-3 ' selected value="NEERO">NEERO</option>
                        <option className='p-3 ' value="BLACK">BLACK</option>
                        <option className='p-3 ' value="WHITE">White</option>
                        <option className='p-3' value="RED">RED</option>
                                                           </select>

                </div>
                <div className='my-3 '>
                    <p className="py-2">Purchess Years</p>
                    <ReactDatePicker className='py-3 pl-3 text-white bg-black border-white' selected={startDate} onChange={(date) => setStartDate(date)} />

                </div>
                <div>
                    <p className="py-3">Desccription</p>
                    <textarea required  {...register("descreption")} className="textarea textarea-secondary text-black font-bold" placeholder="Bio"></textarea>
                </div>

            ...
            <form onSubmit={handleSubmit(addProductSubmit)}>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2'>
                    <div>
                        ...
                        <select className='px-5 py-3 text-white bg-black border-white' {...register("catagory")}>
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        <input type="text" className="input input-bordered w-full text-black font-bold max-w-xs" {...register("names", { required: "Name in required" })} placeholder="Enter Your name" />
                    </div>
                    <div className="form-control w-full max-w-xs">
                        <label className="label">
                        ...
                        } readOnly className="input input-bordered text-black font-bold w-full max-w-xs" />
                    </div>
                    <div className="form-control w-full max-w-xs">
                        <label className="label">
                            <span className="">Email</span>
                        </label>
                        <input type="email" defaultValue={user?.email} readOnly className="input input-bordered w-full text-black font-bold max-w-xs" {...register("eamil", { required: "Name in required" })} placeholder="Enter Your name" />
                    </div>
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        <input type="number" className="input input-bordered w-full text-black font-bold max-w-xs" {...register("RePrice", { required: "Email Address in required" })} placeholder="Enter Your Email" />
                        <br />
                    </div>
                    <div className="form-control w-full max-w-xs">
                        <label className="label">
                        ...
                        <input type="number" className="input input-bordered w-full text-black font-bold max-w-xs" {...register("phone", {
                    ...
                    <div className='my-3 '>
                        ...
                        <DatePicker className='py-3 pl-3 text-white bg-black border-white' selected={startDate} onChange={(date) => setStartDate(date)} />
                    </div>
                    <div>

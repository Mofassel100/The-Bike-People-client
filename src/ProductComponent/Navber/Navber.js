...
const Navber = () => {
  ...
  const myInfo = (
    <React.Fragment>
      ...
      {isSeller && (
        <li
          className="px-2 mx-2 hover:text-lime-400 tooltip-primary tooltip lg:tooltip-right  sm:tooltip-top"
          data-tip=" Admin Dashbord "
        >
          <Link to="/deshbord">Deshbord</Link>
        </li>
      )}
  ...
  const deshbord = <React.Fragment></React.Fragment>;
  return (
    <div className="navbar bg-black text-white font-bold">
      <div className="navbar-start">
        ...
        <a className="btn btn-ghost normal-case text-xl text-lime-600 ">
          RS MOTOR BIKE
        </a>
      </div>
      <div className="navbar-center hidden lg:flex">
        ...
        <ul className="menu menu-horizontal p-0">{myInfo}</ul>
      </div>
      <div className="">

    ...
    <div className="bg-black text-white">
      <div className="grid justify-center items-center py-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-x-6">
          <div>
            <div
              className="hero min-w-screen  hidden lg:block mg:block min-h-screen"
          ...
          <div>
            <div className="card card-title min-w-max py-9 sm:w-72">
              {data?.name}
            </div>
            <div className="card  shadow-xl">
              <div className="lg:hidden md:hidden block">
                {' '}
                <figure>
                  <img src={data?.picture} className="w-72 h-56" alt="Album" />
                </figure>
              </div>
              <div className="card-body">
                <h2 className="card-title">
                  Price :{' '}
                  <span className="text-lime-600 pr-10">
                    {data?.OrginalePrice}
                  </span>
                  Size : {data?.size} <span></span>
                </h2>

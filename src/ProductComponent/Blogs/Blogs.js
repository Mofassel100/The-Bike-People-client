        ...
        <Fragment>
          <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
            ...
            <AccordionBody>
              ...
              well, how to keep your state update logic maintainable, and how to
          ...
          <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
            ...
            <AccordionBody>
              <p className="text-3xl">Ans</p>
              In this article, I will show that unit testing itself is quite
              easy; the real problems that complicate unit testing, and
              introduce expensive complexity, are a result of poorly-designed,
              untestable code. We will discuss what makes code hard to test,
              which anti-patterns and bad practices we should avoid to improve
              testability, and what other benefits we can achieve by writing
              testable code. We will see that writing testable code is not just
              about making testing less troublesome, but about making the code
              itself more robust, and easier to maintain
            </AccordionBody>
          </Accordion>
          <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
            <AccordionHeader onClick={() => handleOpen(3)}>
            ...
            <AccordionBody>
              ...
              All three frameworks provide a solid basis for state-of-the-art
              front ends. Nevertheless, their differences can make one framework
              more favorable than its alternatives.
            </AccordionBody>
          </Accordion>
        </Fragment>
      </div>
